...
#define     AT91C_SYSC_RSTTYP_GENERAL              ((unsigned int) 0x1 <<  8) // (RSTC) General reset. Both VDDCORE and VDDBU rising.
#define     AT91C_SYSC_RSTTYP_WAKEUP               ((unsigned int) 0x2 <<  8) // (RSTC) WakeUp Reset. VDDCORE rising.
#define     AT91C_SYSC_RSTTYP_WATCHDOG             ((unsigned int) 0x3 <<  8) // (RSTC) Watchdog Reset. Watchdog overflow occured.
#define     AT91C_SYSC_RSTTYP_SOFTWARE             ((unsigned int) 0x4 <<  8) // (RSTC) Software Reset. Processor reset required by the software.
#define     AT91C_SYSC_RSTTYP_USER                 ((unsigned int) 0x5 <<  8) // (RSTC) User Reset. NRST pin detected low.
